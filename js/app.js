(() => {
    ...
    (() => {
        ...
        function search(e) {
            const searchButton = document.querySelector(".form-main__button");
            const searchForm = document.querySelector(".form-main__search");
            const formMain = document.querySelector(".form-main");
            const searchInput = document.querySelector("[data-search]");
            if (searchButton) if (e.target == searchButton || e.target == searchForm) formMain.classList.add("_active"); else if (e.target != searchInput) formMain.classList.remove("_active");
        }
        window["FLS"] = true;
        isWebp();
        menuInit();
